        ...
        <div className="slide">
          ...
          >
            <div className="content1">
              ...
              <div className="des">
                ...
                altitude of 3584 meters above sea level. The historical name of
                this region is "Kedar Khand". Kedarnath temple is a part of Char
                Dhams and Panch Kedar in Uttarakhand and one of the 12
                Jyotirlingas of Lord Shiva in India.
              </div>
          ...
          <div className="item" style={{ backgroundImage: `url(${triyugi})` }}>
            <div className="content1">
              ...
              <div className="des">
                ...
                famed for its namesake temple that is dedicated to Lord Vishnu;
                as per the legends, the temple is where Lord Shiva and Goddess
                Parvati got married.
              </div>
              <button className="home-banner-button">See More</button>
              <button className="home-banner-button">Book Now</button>
          ...
          <div className="item" style={{ backgroundImage: `url(${sonark})` }}>
            <div className="content1">
              ...
              <div className="des">
                ...
                rising sun, the temple at Konarak is a monumental representation
                of the sun god Surya's chariot, its 24 wheels are decorated with
                symbolic designs and it is led by a team of six horses. Built in
                the 13th century, it is one of India's most famous Brahman
                sanctuaries.
              </div>
              <button className="home-banner-button">See More</button>
              <button className="home-banner-button">Book Now</button>
          ...
          >
            <div className="content1">
              ...
              <div className="des">
                Vaishno Devi Temple, also known as the Shri Mata Vaishno Devi
                Temple and Vaishno Devi Bhavan, is a Hindu mandir located in
                Katra, Jammu and Kashmir, dedicated to Vaishno Devi, a
                manifestation of Mahakali, Mahalakshmi, and Mahasarasvati. It is
                located on the Trikuta mountain at 5,000 feet / 1,500 meters
                elevation.
              </div>
              <button className="home-banner-button">See More</button>
              <button className="home-banner-button">Book Now</button>
          ...
          >
            <div className="content1">
              ...
              <div className="des">
                Surkanda Devi Temple is a revered Hindu temple located in the
                Uttarakhand state of India. It is situated atop a hill at an
                altitude of about 2,757 meters (9,045 feet) in the Tehri Garhwal
                district. The temple is dedicated to Goddess Surkanda Devi, who
                is believed to be a form of Goddess Durga.
              </div>
              <button className="home-banner-button">See More</button>
              <button className="home-banner-button">Book Now</button>
            </div>
          ...
          >
            <div className="content1">
              ...
              <div className="des">
                Experience the culture of Madurai with this private tour of its
                ancient temples. Spend approximately 45 minutes visiting each of
                the Dravidian temples built by the Pandyan and Madurai Nayak
                kings, earning the city its nickname Koil Maanagar, which means
                Temple City. Discover why Madurai, also called the City of
                Junctions or Koodal Nagaram, is one of India's most outstanding
